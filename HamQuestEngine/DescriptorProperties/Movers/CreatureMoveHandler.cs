                ...
                if (creature == Map.PlayerCreature)
                {
                    ...
                    while (numberOfAttacks > 0 && !creature.Dead)
                    {
                        ...
                        if (damage > 0)
                        {
                            ...
                            {
                                if (creatureDescriptor.HasProperty(GameConstants.Properties.ItemBlocks) && descriptor.HasItem(creatureDescriptor.GetProperty<string>(GameConstants.Properties.ItemBlocks)))
                                {
